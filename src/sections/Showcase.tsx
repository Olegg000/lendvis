...
export function Showcase({ projects }: { projects: Project[] }) {
  ...
  // и часть содержимого станет недостижимой. Раньше порог был угадан числом (820px)
  // и на обычном ноутбуке стопка молча выключалась; теперь меряем по факту.
...
function StackItem({
  ...
  return (
    <div
      className={stick ? '' : 'mb-6 last:mb-0'}
